 ...
 */
AlfredItem.prototype.addItem = function(uid, title, subtitle, arg, icon, options) {
    var item = {
        item: [
            { _attr: { uid: uid } }
        ]
...
/**
 * delete an item via arg
 * @param {String} arg the arg
 */
AlfredItem.prototype.delItemViaArg = function(arg) {
    this.delItemViaArg("arg", arg);
};
